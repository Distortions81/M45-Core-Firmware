...
#define HTTP_SERVER_TASK_PRIORITY (tskIDLE_PRIORITY + 4)
#define HTTP_SERVER_TASK_CORE_ID 0
#define HTTP_SERVER_MAX_OPEN_SOCKETS 6
#define HTTP_SERVER_BACKLOG_CONNECTIONS 4
#define HTTP_SERVER_MAX_RESPONSE_HEADERS 12
