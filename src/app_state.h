...
#define APP_CLASSIC_HARDWARE_SHA_MINER 1
#define APP_S3_HARDWARE_SHA_MINER 0
#define APP_HARDWARE_SHA_MINER 1
#elif defined(CONFIG_IDF_TARGET_ESP32S3)
#define APP_CLASSIC_HARDWARE_SHA_MINER 0
#ifndef APP_S3_HARDWARE_SHA_MINER
#define APP_S3_HARDWARE_SHA_MINER 1
#endif
#define APP_HARDWARE_SHA_MINER APP_S3_HARDWARE_SHA_MINER
#else
...
#endif
#ifndef APP_STRATUM_HARDWARE_MINE_BATCH
#if APP_S3_HARDWARE_SHA_MINER
#define APP_STRATUM_HARDWARE_MINE_BATCH 8192
#else
#define APP_STRATUM_HARDWARE_MINE_BATCH APP_STRATUM_MINE_BATCH
#endif
#endif
...
#endif
#ifndef APP_STRATUM_SOFTWARE_STALE_WORK_CHECK_NONCES
#if defined(CONFIG_IDF_TARGET_ESP32S3)
#define APP_STRATUM_SOFTWARE_STALE_WORK_CHECK_NONCES 2048U
#else
#define APP_STRATUM_SOFTWARE_STALE_WORK_CHECK_NONCES 256U
#endif
#endif
#ifndef APP_STRATUM_SOFTWARE_MINER_TASK_COUNT
#if APP_HARDWARE_SHA_MINER
#define APP_STRATUM_SOFTWARE_MINER_TASK_COUNT 1
#else
#define APP_STRATUM_SOFTWARE_MINER_TASK_COUNT portNUM_PROCESSORS
#endif
#endif
...
#define STRATUM_HARDWARE_MINE_BATCH APP_STRATUM_HARDWARE_MINE_BATCH
...
#define STRATUM_SOFTWARE_STALE_WORK_CHECK_NONCES APP_STRATUM_SOFTWARE_STALE_WORK_CHECK_NONCES
#define STRATUM_SOFTWARE_MINER_TASK_COUNT APP_STRATUM_SOFTWARE_MINER_TASK_COUNT
...
#ifndef APP_STRATUM_SHARE_QUEUE_MAX
#define APP_STRATUM_SHARE_QUEUE_MAX 32
#endif
#define STRATUM_SHARE_QUEUE_MAX APP_STRATUM_SHARE_QUEUE_MAX
